  ...
  return (
   ...
   <>
    ...
    <div className='flex gap-6 items-center justify-center w-full'>
           <CTAButton type='outlined-black' onClick={()=>setOpen(false)}>
            Cancel
           </CTAButton>

           <CTAButton type='warning' onClick={()=>{
            deleteUserChat(chat.chatId, profileId, setOpen)}
            }>
            Delete Chat
           </CTAButton>
    </div>
...
<Modal setClose = {()=>setblockModal(false)}>
   <>
    ...
    <div className='flex gap-6 items-center justify-center w-full'>
           <CTAButton type='outlined-black' onClick={()=>setblockModal(false)}>
            Cancel
           </CTAButton>

           <CTAButton type='warning' onClick={() => dispatch(blockUser(chat.chatId, chat.userId, setblockModal, !chat.blocked))}>
